...
function Library:CreateWindow(config)
	...
	clicked(minimize, function()
		...
		local yOffset = window.Collapsed and offset or -offset
		main.Position = UDim2.new(position.X.Scale, position.X.Offset, position.Y.Scale, position.Y.Offset + yOffset)
		main.Size = UDim2.fromOffset(width, window.Collapsed and 58 or height)
	end)
